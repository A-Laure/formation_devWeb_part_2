...
class UserModel extends CoreModel
{
  ...
  public function readAll()
  {
    ...
    $query = 'SELECT 
  u.user_Id AS user_idUser, u.user_firstName, u.user_lastName, u.user_email, u.user_pwd, u.user_lastMove, r.role_Id AS role_roleId, r.role_label AS role_roleLabel, r.role_power AS role_rolePower 
  FROM user u 
  ...
  public function readOne($id)
  {
    try {
      ...
      $query = 'SELECT u.user_Id AS user_idUser, u.user_firstName, u.user_lastName, u.user_email, u.user_pwd, u.user_lastMove, r.role_Id AS role_roleId, r.role_label AS role_roleLabel, r.role_power AS role_rolePower
    FROM user u 
    JOIN role r  ON u.role_Id = r.role_Id 
    WHERE user_Id = :id';
